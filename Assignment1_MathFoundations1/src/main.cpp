...
int main() {
    ...
    std::cout << "Passed 6: " << testMakeRotationX() << " \n";
    std::cout << "Passed 7: " << testMakeRotationY() << " \n";
    std::cout << "Passed 8: " << testMakeRotationZ() << " \n";
    std::cout << "Passed 9: " << testMakeScale() << " \n";
    std::cout << "Passed 10: " << testMultiplyMatrices() << " \n";
    std::cout << "Passed 11: " << testMultiplyMatrixWithVectors() << " \n";

    std::cout << "Passed 12: " << vectorTestMultiplyByScalar()  << " \n";
    std::cout << "Passed 13: " << vectorTestDivisionByScalar()  << " \n";
    std::cout << "Passed 14: " << vectorTestNegation() << " \n";
    std::cout << "Passed 15: " << vectorTestMagnitude() << " \n";
    std::cout << "Passed 16: " << vectorTestAddition() << " \n";
    std::cout << "Passed 17: " << vectorTestSubtraction() << " \n";
    std::cout << "Passed 18: " << vectorTestVectorProjection() << " \n";
    std::cout << "Passed 19: " << vectorTestVectorNormalize() << " \n";
    std::cout << "Passed 20: " << vectorTestVectorCrossProduct() << " \n";
